...
**Materials**: writing a `.mat` file is real shader work material shading
language is GLSL embedded in a small config wrapper, compiled by `matc` (already part
of the build, runs automatically).
...
Built using some of [Filament](https://github.com/google/filament), Google's real-time PBR
