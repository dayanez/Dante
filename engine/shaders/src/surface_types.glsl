...
#define DANTE_OBJECT_SKINNING_ENABLED_BIT   0x100
#define DANTE_OBJECT_MORPHING_POSITION_BIT  0x200
#define DANTE_OBJECT_MORPHING_TANGENT_BIT  0x400
#define DANTE_OBJECT_MORPHING_CUSTOM_BIT    0x800
#define DANTE_OBJECT_CONTACT_SHADOWS_BIT    0x1000
#define DANTE_OBJECT_INSTANCE_BUFFER_BIT    0x2000
