...
#ifndef TNT_DANTE_FRAMEPACER_H
#define TNT_DANTE_FRAMEPACER_H
 ...
 *
 *  dante::FramePacer* pacer = dante::FramePacer::Builder()
 ...
 *  void onChoreographerTick(const dante::FramePacer::VsyncTick& tick) {
 *      if (pacer->setupFrame(tick) != dante::FramePacer::FrameStatus::ACCEPTED) {
 ...
 * ~~~~~~~~~~~
 */
class UTILS_PUBLIC FramePacer : public DanteAPI {
public:
    ...
    public:
         ...
         *
         * @param engine Reference to the dante::Engine to associate this FramePacer with.
     ...
     *
     * @param renderer The Dante Renderer displaying the target View.
