...
#ifndef TNT_DANTE_RENDERABLEMANAGER_H
#define TNT_DANTE_RENDERABLEMANAGER_H
 ...
 */
class UTILS_PUBLIC RenderableManager : public DanteAPI {
...
public:
    ...
    public:
         ...
         *
         * Dante primitives normally have an associated vertex buffer and index buffer. Typically,
         ...
         *
         * If no material is specified for a given primitive, Dante will fall back to a basic
         * default material.
         *
         ...
         *
         * In general Dante reserves the right to re-order renderables to allow for efficient
         ...
         * or by calling dantemat::MaterialBuilder::useLegacyMorphing().
         *
         ...
         * required to enable GPU morphing.
         *
         * Dante supports two morphing modes: standard (default) and legacy.
         *
         ...
         *
         * @param engine Reference to the dante::Engine to associate this Renderable with.
...
#endif // TNT_DANTE_RENDERABLEMANAGER_H
