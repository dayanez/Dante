...
#ifndef TNT_DANTE_INDEXBUFFER_H
#define TNT_DANTE_INDEXBUFFER_H
 ...
 */
class UTILS_PUBLIC IndexBuffer : public DanteAPI {
...
public:
    ...
    public:
         ...
         *
         * @param engine Reference to the dante::Engine to associate this IndexBuffer with.
         *
