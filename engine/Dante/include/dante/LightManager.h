...
#ifndef TNT_DANTE_LIGHTMANAGER_H
#define TNT_DANTE_LIGHTMANAGER_H
 ...
 *
 *  dante::LightManager::Builder(Type::SUN)
 *              .castShadows(true)
 *              .build(*engine, sun);
 *
 ...
 * ==========================
 *
 * Generally, adding lights to the scene hurts performance, however dante is designed to be
 ...
 *
 */
class UTILS_PUBLIC LightManager : public DanteAPI {
...
public:
    ...
    struct ShadowOptions {
         ...
         *
         * Dante provides utility methods inside LightManager::ShadowCascades to help set these
    ...
    public:
         ...
         *
         * @param engine Reference to the dante::Engine to associate this light with.
...
#endif // TNT_DANTE_LIGHTMANAGER_H
