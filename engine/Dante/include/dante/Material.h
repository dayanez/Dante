...
#ifndef TNT_DANTE_MATERIAL_H
#define TNT_DANTE_MATERIAL_H
 ...
 *
 */
class UTILS_PUBLIC Material : public DanteAPI {
...
public:
    ...
    public:
         ...
         *
         * @param engine Reference to the dante::Engine to associate this Material with.
         *
