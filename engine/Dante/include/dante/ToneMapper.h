...
#ifndef TNT_DANTE_TONEMAPPER_H
#define TNT_DANTE_TONEMAPPER_H
 ...
 *
 * In Dante, tone mapping is a color grading step. ToneMapper instances are
 ...
 *
 * Dante provides several default tone mapping operators that fall into three
 * categories:
 *
 ...
 * and historically Dante's default tone mapping operator. It exists
