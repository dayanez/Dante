...
#ifndef TNT_DANTE_CAMERA_H
#define TNT_DANTE_CAMERA_H
 ...
 * ========================
 *
 * In Dante, Camera is a component that must be associated with an entity. To do so,
 ...
 *  dante::Camera* myCamera = engine->createCamera(myCameraEntity);
 ...
 * \see Frustum, View
 */
class UTILS_PUBLIC Camera : public DanteAPI {
public:
