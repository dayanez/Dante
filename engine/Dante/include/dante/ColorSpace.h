...
#ifndef TNT_DANTE_COLOR_SPACE_H
#define TNT_DANTE_COLOR_SPACE_H

#include <math/vec2.h>

namespace dante::color {
...
/**
 * <p>A color space in Dante is always an RGB color space. A specific RGB color space
