...
#ifndef TNT_DANTE_SKYBOX_H
#define TNT_DANTE_SKYBOX_H
 ...
 *
 *  dante::IndirectLight* skybox = dante::Skybox::Builder()
 *              .environment(cubemap)
 *              .build(*engine);
 *
 ...
 */
class UTILS_PUBLIC Skybox : public DanteAPI {
...
public:
    ...
    public:
         ...
         *
         * @param engine Reference to the dante::Engine to associate this Skybox with.
         *
