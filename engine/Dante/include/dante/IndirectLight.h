...
#ifndef TNT_DANTE_INDIRECTLIGHT_H
#define TNT_DANTE_INDIRECTLIGHT_H
 ...
 *
 *  dante::IndirectLight* environment = dante::IndirectLight::Builder()
 *              .reflections(cubemap)
 *              .build(*engine);
 *
 ...
 */
class UTILS_PUBLIC IndirectLight : public DanteAPI {
...
public:
    ...
    public:
         ...
         *
         * @param engine Reference to the dante::Engine to associate this IndirectLight with.
         *
...
#endif // TNT_DANTE_INDIRECTLIGHT_H
