...
#ifndef TNT_DANTE_VERTEXBUFFER_H
#define TNT_DANTE_VERTEXBUFFER_H
 ...
 */
class UTILS_PUBLIC VertexBuffer : public DanteAPI {
...
public:
    ...
    public:
         ...
         * slightly increase the memory footprint of Dante's internal bookkeeping.
         *
         ...
         *
         * @param engine Reference to the dante::Engine to associate this VertexBuffer with.
         *
...
#endif // TNT_DANTE_VERTEXBUFFER_H
