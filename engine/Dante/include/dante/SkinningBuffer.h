...
#ifndef TNT_DANTE_SKINNINGBUFFER_H
#define TNT_DANTE_SKINNINGBUFFER_H
 ...
 */
class UTILS_PUBLIC SkinningBuffer : public DanteAPI {
...
public:
    ...
    public:
         ...
         *
         * @param engine Reference to the dante::Engine to associate this SkinningBuffer with.
         *
...
#endif //TNT_DANTE_SKINNINGBUFFER_H
