...
#ifndef TNT_DANTE_RENDERER_H
#define TNT_DANTE_RENDERER_H
 ...
 * @see Engine, View
 */
class UTILS_PUBLIC Renderer : public DanteAPI {
public:
     ...
     *
     * This is dante main rendering method, most of the CPU-side heavy lifting is performed
