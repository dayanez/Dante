...
#ifndef TNT_DANTE_MATERIALINSTANCE_H
#define TNT_DANTE_MATERIALINSTANCE_H
 ...
 *
 */
class UTILS_PUBLIC MaterialInstance : public DanteAPI {
    template<size_t N>
...
#endif // TNT_DANTE_MATERIALINSTANCE_H
