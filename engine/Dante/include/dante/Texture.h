...
#ifndef TNT_DANTE_TEXTURE_H
#define TNT_DANTE_TEXTURE_H
 ...
 *
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{.cpp}
 *  dante::Engine* engine = dante::Engine::create();
 *
 *  dante::Texture* texture = dante::Texture::Builder()
 *              .width(64)
 *              .height(64)
 *              .build(*engine);
 *
 ...
 *
 */
class UTILS_PUBLIC Texture : public DanteAPI {
...
public:
    ...
    public:
         ...
         *
         * @param engine Reference to the dante::Engine to associate this Texture with.
         *
        ...
        /**
         * Specify a native texture to import as a Dante texture.
         *
         ...
         * CFBridgingRetain to transfer ownership to Dante. Dante will release ownership of
         * the texture object when the Dante texture is destroyed.
         *
         * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{.cpp}
         *  id <MTLTexture> metalTexture = ...
         *  danteTexture->import((intptr_t) CFBridgingRetain(metalTexture));
         *  // free to release metalTexture
         *
         *  // after using texture:
         *  engine->destroy(danteTexture);   // metalTexture is released
         * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
         *
     ...
     *
     * A single external image can be bound to different Dante textures, with each texture
