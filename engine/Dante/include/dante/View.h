...
#ifndef TNT_DANTE_VIEW_H
#define TNT_DANTE_VIEW_H
 ...
 */
class UTILS_PUBLIC View : public DanteAPI {
public:
    using QualityLevel = dante::QualityLevel;
    using BlendMode = dante::BlendMode;
    using AntiAliasing = dante::AntiAliasing;
    using Dithering = dante::Dithering;
    using ShadowType = dante::ShadowType;

    using DynamicResolutionOptions = dante::DynamicResolutionOptions;
    using BloomOptions = dante::BloomOptions;
    using FogOptions = dante::FogOptions;
    using DepthOfFieldOptions = dante::DepthOfFieldOptions;
    using VignetteOptions = dante::VignetteOptions;
    using RenderQuality = dante::RenderQuality;
    using AmbientOcclusionOptions = dante::AmbientOcclusionOptions;
    using TemporalAntiAliasingOptions = dante::TemporalAntiAliasingOptions;
    using MultiSampleAntiAliasingOptions = dante::MultiSampleAntiAliasingOptions;
    using VsmShadowOptions = dante::VsmShadowOptions;
    using SoftShadowOptions = dante::SoftShadowOptions;
    using ScreenSpaceReflectionsOptions = dante::ScreenSpaceReflectionsOptions;
    using GuardBandOptions = dante::GuardBandOptions;
    using StereoscopicOptions = dante::StereoscopicOptions;
