...
#ifndef TNT_DANTE_BUFFEROBJECT_H
#define TNT_DANTE_BUFFEROBJECT_H
 ...
 * @see VertexBuffer
 */
class UTILS_PUBLIC BufferObject : public DanteAPI {
...
public:
    ...
    public:
         ...
         *
         * @param engine Reference to the dante::Engine to associate this BufferObject with.
         *
     ...
     *
     * @param engine Reference to the dante::Engine associated with this BufferObject.
...
#endif // TNT_DANTE_BUFFEROBJECT_H
