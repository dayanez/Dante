...
#ifndef TNT_DANTE_MORPHTARGETBUFFER_H
#define TNT_DANTE_MORPHTARGETBUFFER_H
 ...
 */
class UTILS_PUBLIC MorphTargetBuffer : public DanteAPI {
...
public:
    ...
    public:
         ...
         *
         * @param engine Reference to the dante::Engine to associate this MorphTargetBuffer with.
         *
     ...
     *
     * @param engine Reference to the dante::Engine associated with this MorphTargetBuffer.
...
#endif //TNT_DANTE_MORPHTARGETBUFFER_H
