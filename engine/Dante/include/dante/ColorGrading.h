...
#ifndef TNT_DANTE_COLORGRADING_H
#define TNT_DANTE_COLORGRADING_H
 ...
 * rendered by Dante. Color grading transforms are applied after lighting, and after any lens
 ...
 *
 *  dante::ColorGrading* colorGrading = dante::ColorGrading::Builder()
 *              .toneMapping(dante::ColorGrading::ToneMapping::ACES)
 *              .build(*engine);
 *
 ...
 * ===========
 *
 * Creating a new ColorGrading object may be more expensive than other Dante objects as a LUT may
 ...
 * @see View
 */
class UTILS_PUBLIC ColorGrading : public DanteAPI {
...
public:
    ...
    enum class UTILS_DEPRECATED ToneMapping : uint8_t {
        ...
        ACES_LEGACY   = 1,     //!< ACES tone mapping, with a brightness modifier to match Dante's legacy tone mapper
    ...
    public:
         ...
         *
         * @param engine Reference to the dante::Engine to associate this ColorGrading with.
         *
...
#endif // TNT_DANTE_COLORGRADING_H
