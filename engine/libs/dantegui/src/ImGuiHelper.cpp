...
#include "generated/resources/dantegui_resources.h"
...
ImGuiHelper::ImGuiHelper(Engine* engine, dante::View* view, const Path& fontPath,
    ...
    mMaterial2d = Material::Builder()
            .package(DANTEGUI_RESOURCES_UIBLIT_DATA, DANTEGUI_RESOURCES_UIBLIT_SIZE)
            .build(*engine);
#ifdef __ANDROID__
    mMaterialExternal = Material::Builder()
            .package(DANTEGUI_RESOURCES_UIBLITEXTERNAL_DATA, DANTEGUI_RESOURCES_UIBLITEXTERNAL_SIZE)
            .build(*engine);
#endif
