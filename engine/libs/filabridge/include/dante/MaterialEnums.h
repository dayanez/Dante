...
#ifndef TNT_DANTE_MATERIAL_ENUM_H
#define TNT_DANTE_MATERIAL_ENUM_H
...
// update this when a new version of dante wouldn't work with older materials
...
static constexpr size_t MAX_MORPH_TARGETS =
        256; // this is limited by dante::CONFIG_MAX_MORPH_TARGET_COUNT
...
template<>
struct utils::EnableBitMaskOperators<dante::UserVariantFilterBit> : public std::true_type {};

template<>
struct utils::EnableIntegerOperators<dante::UserVariantFilterBit> : public std::true_type {};
