...
#ifndef TNT_DANTE_ENGINE_ENUM_H
#define TNT_DANTE_ENGINE_ENUM_H
...
// The number of specialization constants that Dante reserves for its own
...
// The maximum number of instances that Dante automatically creates as an optimization.
...
#if defined(__EMSCRIPTEN__) && !defined(DANTE_SUPPORTS_WEBGPU)
...
template<>
struct utils::EnableIntegerOperators<dante::DescriptorSetBindingPoints> : public std::true_type {};
template<>
struct utils::EnableIntegerOperators<dante::PerViewBindingPoints> : public std::true_type {};
template<>
struct utils::EnableIntegerOperators<dante::PerRenderableBindingPoints> : public std::true_type {};
template<>
struct utils::EnableIntegerOperators<dante::PerMaterialBindingPoints> : public std::true_type {};

template<>
struct utils::EnableIntegerOperators<dante::ReservedSpecializationConstants> : public std::true_type {};
template<>
struct utils::EnableIntegerOperators<dante::DynamicSpecializationConstants> : public std::true_type {};
template<>
struct utils::EnableIntegerOperators<dante::PushConstantIds> : public std::true_type {};
template<>
struct utils::EnableIntegerOperators<dante::PostProcessVariant> : public std::true_type {};

template<>
inline constexpr size_t utils::Enum::count<dante::PostProcessVariant>() { return dante::POST_PROCESS_VARIANT_COUNT; }

#endif // TNT_DANTE_ENGINE_ENUM_H
