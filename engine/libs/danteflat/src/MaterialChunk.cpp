...
bool MaterialChunk::initialize(dantemat::ChunkType const materialTag) {
    ...
    bool const isTextChunk = (
            mMaterialTag == dantemat::ChunkType::MaterialGlsl ||
            mMaterialTag == dantemat::ChunkType::MaterialEssl1 ||
            mMaterialTag == dantemat::ChunkType::MaterialWgsl ||
            mMaterialTag == dantemat::ChunkType::MaterialMetal);
...
bool MaterialChunk::getShader(ShaderContent& shaderContent, BlobDictionary const& dictionary,
    ...
    switch (mMaterialTag) {
        case dantemat::ChunkType::MaterialGlsl:
        case dantemat::ChunkType::MaterialEssl1:
        case dantemat::ChunkType::MaterialWgsl:
        case dantemat::ChunkType::MaterialMetal:
            return getTextShader(mUnflattener, dictionary, shaderContent, shaderModel, variant, stage);
        case dantemat::ChunkType::MaterialSpirv:
        case dantemat::ChunkType::MaterialMetalLibrary:
