...
#ifndef GLTFIO_DANTEINSTANCE_H
#define GLTFIO_DANTEINSTANCE_H
...
/**
 * \class DanteInstance DanteInstance.h gltfio/DanteInstance.h
 ...
 */
class UTILS_PUBLIC DanteInstance {
public:
    /**
     * Gets the owner of this instance.
     */
    DanteAsset const* getAsset() const noexcept;
     ...
     * originating DanteAsset. In the latter case, the animation frame is shared amongst all
