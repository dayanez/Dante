...
public:
    ...
    dante::UserVariantFilterMask getVariantFilter() const noexcept {
    ...
    dante::backend::FeatureLevel getFeatureLevel() const noexcept {
...
protected:
    ...
    dante::backend::FeatureLevel mFeatureLevel = dante::backend::FeatureLevel::FEATURE_LEVEL_3;
    StringReplacementMap mDefines;
    StringReplacementMap mTemplateMap;
    StringReplacementMap mMaterialParameters;
    dante::UserVariantFilterMask mVariantFilter = 0;
