...
bool IBL::loadFromEquirect(Path const& path) {
    ...
    // Dante deviation from upstream Dante: EquirectangularToCubemap defaults to a
...
bool IBL::loadCubemapLevel(dante::Texture** texture, const utils::Path& path, size_t level,
