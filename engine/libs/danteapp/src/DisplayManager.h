...
#ifndef TNT_DANTE_DANTEAPP_DISPLAY_MANAGER_H
#define TNT_DANTE_DANTEAPP_DISPLAY_MANAGER_H
...
/**
 * Display manager interface for DanteApp.
 */
...
public:
     ...
     */
    virtual DanteApp::Window::Handle createWindow(const char* title, uint32_t w, uint32_t h,
     ...
     */
    virtual void destroyWindow(DanteApp::Window::Handle window) = 0;
     ...
     * platforms.
     */
    virtual void* getNativeWindow(DanteApp::Window::Handle window) const = 0;
     ...
     */
    virtual void setWindowTitle(DanteApp::Window::Handle window, const char* title) = 0;
     ...
     */
    virtual void getWindowSize(DanteApp::Window::Handle window, uint32_t* w,
            uint32_t* h) const = 0;
     ...
     * @param h Pointer to store the height.
     */
    virtual void getDrawableSize(DanteApp::Window::Handle window, uint32_t* w,
            uint32_t* h) const = 0;
     ...
     * @param window The window handle.
     */
    virtual void onWindowResized(DanteApp::Window::Handle window) {}
     ...
     */
    virtual bool isWindowFocused(DanteApp::Window::Handle window) const { return true; }
     ...
     * @param window The window handle.
     * @param engine The Dante engine.
     * @param renderer The Dante renderer.
     */
    virtual void onFrameFinished(DanteApp::Window::Handle window, dante::Engine* engine,
            dante::Renderer* renderer) {}
...
#endif // TNT_DANTE_DANTEAPP_DISPLAY_MANAGER_H
