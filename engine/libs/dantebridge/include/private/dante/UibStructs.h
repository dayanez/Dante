...
#ifndef TNT_DANTEBRIDGE_UIBSTRUCTS_H
#define TNT_DANTEBRIDGE_UIBSTRUCTS_H
...
/*
 * Here we define all the UBOs known by dante as C structs. It is used by dante to
 * fill the uniform values and get the interface block names. It is also used by dantebridge to
...
#endif // TNT_DANTEBRIDGE_UIBSTRUCTS_H
